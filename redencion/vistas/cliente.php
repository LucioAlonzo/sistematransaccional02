...
<!-- Modal -->
<form method="POST" action="../modal/add_clie.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        <div class="col">
                            <input class="form-control" placeholder="NIT" name="nit">
                        </div>
                    </div>

                    <div class="input-group mb-3">
                        <div class="col">
                            <input class="form-control" placeholder="Correo" name="correo">
                        </div>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="col">
                            <input class="form-control" placeholder="Telefono 1" name="tel1">
                        </div>
                    </div>

                    <div class="input-group mb-3">
                        <div class="col">
                            <input class="form-control" placeholder="Telefono 2" name="tel2">
                        </div>
                    </div>
                    <!--
